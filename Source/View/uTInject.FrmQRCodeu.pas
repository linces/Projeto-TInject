...
uses
  ...
  uTInject.Constant, uniGUIBaseClasses, uniGUIClasses, uniTimer, uniImage, uniGUITypes, uniGUIAbstractClasses, uniGUIForm, uniGUIApplication;

type
  TFrmQRCodeu = class(TUniForm)
    Timg_QrCode: TUniImage;
    Timg_Animacao: TUniImage;
...
//    procedure FormCloseQuery(Sender: TObject; var CanClose: Boolean);
  ...
  public
    ...
    Procedure  SetView     (Const PImage: TUniImage);
  end;

var
  FrmQRCodeu: TFrmQRCodeu;
...
procedure TFrmQRCodeu.FormClose(Sender: TObject; var Action: TCloseAction);
begin
...
procedure TFrmQRCodeu.FormCreate(Sender: TObject);
begin
...
procedure TFrmQRCodeu.FormDestroy(Sender: TObject);
begin
  FTimerGetQrCode.Enabled := False;
...
procedure TFrmQRCodeu.FormHide(Sender: TObject);
begin
  if FFormQrCodeType = Ft_Desktop Then
     FTimerGetQrCode.Enabled  := False;
end;

procedure TFrmQRCodeu.FormShow(Sender: TObject);
begin
  if not FShow then
  Begin
    FShow := true;
...
procedure TFrmQRCodeu.SetView(const PImage: TImage);
var
  LImage : TImage;
begin
  AutoSize := False;
...
procedure TFrmQRCodeu.ShowForm(PFormQrCodeType: TFormQrCodeType);
begin
